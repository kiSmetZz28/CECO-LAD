...
The demo video (`demo.mp4`) is **not included in this repository** because it exceeds
GitHub's 100 MB file size limit.

**To watch the demo**, visit the live HF Space:
👉 https://huggingface.co/spaces/kiSmetZz/ceco-lad
